...
- If you are unsure which model you need, check [../docs/catalog.md](../docs/catalog.md) first.
...
## Status
- EN: main entry
- ZH: source materials exist in the subtree folders
- TBD: model-specific details are maintained in each subtree
